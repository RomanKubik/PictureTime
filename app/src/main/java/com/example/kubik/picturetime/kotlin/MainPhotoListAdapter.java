...
public class MainPhotoListAdapter extends StrangeAdapter<PhotoDetails> {
    ...
    public StrangeHolder<PhotoDetails> onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(view, getPourColor());
    }

    @Override
    public void onBindViewHolder(StrangeHolder<? super PhotoDetails> holder, int position) {
        holder.setItem(getItemList().get(position));
    }
